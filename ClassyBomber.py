...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("ClassyBomber is up-to-date")
        mesgdcrt.GeneralMessage("Starting ClassyBomber")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("RevengeBomber was modified by Alex Bieber")
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("ClassyBomber will work only in Python v3")
    sys.exit()
